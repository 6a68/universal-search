...
Recommendation.prototype = {
  ...
  onMouseEnter: function(evt) {
    ...
    this.win.console.log('recommendation firing mouseenter', Date.now());
    this.events.publish('recommendation-mouseenter', evt);
  },
  onMouseLeave: function(evt) {
    // TODO: need to throttle this?
    this.win.console.log('recommendation firing mouseleave', Date.now());
    this.events.publish('recommendation-mouseleave', evt);
  },
  onMouseMove: function(evt) {
    // mousemove fires many times as the mouse moves across the surface of the
    // element, so we must debounce it.
