...
Search.prototype = {
  ...
  _loadScripts: function(win) {
    ...
    Cu.import('resource://gre/modules/Console.jsm', win.US);

    Cu.import('chrome://universalsearch-lib/content/events.js', win.US);
    Cu.import('chrome://universalsearch-lib/content/recommendation-server.js', win.US);

    Cu.import('chrome://universalsearch-ui/content/urlbar.js', win.US);
    Cu.import('chrome://universalsearch-ui/content/recommendation.js', win.US);
    Cu.import('chrome://universalsearch-ui/content/highlight-manager.js', win.US);
  },
  ...
  _unloadScripts: function(win) {
    ...
    Cu.unload('chrome://universalsearch-ui/content/urlbar.js', win.US);
    Cu.unload('chrome://universalsearch-ui/content/recommendation.js', win.US);
    Cu.unload('chrome://universalsearch-ui/content/highlight-manager.js', win.US);

    Cu.unload('chrome://universalsearch-lib/content/recommendation-server.js', win.US);
    Cu.unload('chrome://universalsearch-lib/content/events.js', win.US);

    Cu.unload('resource://gre/modules/Console.jsm', win.US);
  },
